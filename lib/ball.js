...
Ball.prototype.isCollidedWith = function (otherBall) {
	...
	return distanceBetween < (this.radius + otherBall.radius)*0.75;
};
...
Ball.prototype.ballCollision = function (otherInitialVelocity) {
	var xVelocity = 0.5*(otherInitialVelocity[0]*(1 + BALL_BALL_RESTITUTION) + 
									this.velocity[0]*(1 - BALL_BALL_RESTITUTION));
	var yVelocity = 0.5*(otherInitialVelocity[1]*(1 + BALL_BALL_RESTITUTION) + 
