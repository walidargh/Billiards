...
Ball.prototype.move = function (timeDelta) {
	...
	this.velocity = this.tableFriction(this.velocity);
};

Ball.prototype.tableFriction = function (velocity) {
	var xVelocity = this.directionFriction(velocity[0]);
	var yVelocity = this.directionFriction(velocity[1]);
