...
Game.prototype.populateTable = function () {
	...
	game.balls = {};
		...
		// 	));
		// }
		game.balls[0] = new Ball({position: [100, 100], velocity: [100, 100], number: 0, suit: "club", game: game, color: "#000000"})
		game.balls[1] = new Ball({position: [1000, 100], velocity: [-100, 100], number: 1, suit: "club", game: game, color: "#FFFFFF"})
