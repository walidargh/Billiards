...
Game.prototype.draw = function (ctx, event) {
	...
	ctx.fillRect(
		Game.offSet/2 - 60, Game.offSet/4, Game.DIM_X + 120, Game.DIM_Y
	);

	ctx.fillRect(
		Game.offSet/2, Game.offSet/4 - 60, Game.DIM_X, Game.DIM_Y + 120
	);
...
Game.prototype.drawCorners = function(ctx) {
	...
	ctx.beginPath();
	ctx.arc(
		Game.offSet/2, Game.offSet/4, 60, 1.5*Math.PI, Math.PI, true
	);
	...
	ctx.beginPath();
	ctx.arc(
		Game.offSet/2 + Game.DIM_X, Game.offSet/4, 60, 0, 1.5 * Math.PI, true
	);
	...
	ctx.arc(
		...
		Game.offSet/4 + Game.DIM_Y, 60, 0.5*Math.PI, 2 * Math.PI, true
	);
	...
	ctx.fillRect(
		Game.offSet/2, Game.offSet/4, 30, -60
	);
	ctx.fillRect(
		Game.offSet/2, Game.offSet/4, -60, 30
	);

	ctx.fillRect(
		Game.DIM_X + Game.offSet/2, Game.offSet/4, 60, 30
	);
	ctx.fillRect(
		Game.offSet/2, Game.offSet/4, 30, 60
	);
