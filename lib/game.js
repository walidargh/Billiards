...
Game.positions =
{
	1: [Game.DIM_X/2 + 4*20, Game.DIM_Y/2],

	2: [Game.DIM_X/2 + 2*20, Game.DIM_Y/2 - 1*20],
	3: [Game.DIM_X/2 + 2*20, Game.DIM_Y/2 + 1*20],

	4: [Game.DIM_X/2 + 0*20, Game.DIM_Y/2 - 2*20],
	5: [Game.DIM_X/2 + 0*20, Game.DIM_Y/2 - 0*20],
	6: [Game.DIM_X/2 + 0*20, Game.DIM_Y/2 + 2*20],

	7: [Game.DIM_X/2 - 2*20, Game.DIM_Y/2 - 3*20],
	8: [Game.DIM_X/2 - 2*20, Game.DIM_Y/2 - 1*20],
	9: [Game.DIM_X/2 - 2*20, Game.DIM_Y/2 + 1*20],
	10: [Game.DIM_X/2 - 2*20, Game.DIM_Y/2 + 3*20],

	11: [Game.DIM_X/2 - 4*20, Game.DIM_Y/2 - 4*20],
	12: [Game.DIM_X/2 - 4*20, Game.DIM_Y/2 - 2*20],
	13: [Game.DIM_X/2 - 4*20, Game.DIM_Y/2 + 0*20],
	14: [Game.DIM_X/2 - 4*20, Game.DIM_Y/2 + 2*20],
	15: [Game.DIM_X/2 - 4*20, Game.DIM_Y/2 + 4*20]
};
