...
Game.prototype.draw = function (ctx, event) {
	...
	ctx.beginPath();
	ctx.arc(
		Game.offSet/2, Game.offSet/4, 50, 0, 2 * Math.PI, true
	);
	ctx.fill();
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.arc(
		Game.offSet/2 + Game.DIM_X, Game.offSet/4, 50, 0, 2 * Math.PI, true
	);
	ctx.fill();
	ctx.closePath();
	...
	ctx.beginPath();
	ctx.arc(
		Game.offSet/2, Game.offSet/4 + Game.DIM_Y, 50, 0, 2 * Math.PI, true
	);
	ctx.fill();
	ctx.closePath();
	...
	ctx.arc(
		...
		Game.offSet/4 + Game.DIM_Y, 50, 0, 2 * Math.PI, true
	);
	ctx.fill();
	ctx.closePath();
