...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.positions =
	{
		1: [Game.DIM_X/2 + 4*15, Game.DIM_Y/2],
	
		2: [Game.DIM_X/2 + 2*15, Game.DIM_Y/2 - 1*15],
		3: [Game.DIM_X/2 + 2*15, Game.DIM_Y/2 + 1*15],
	
		4: [Game.DIM_X/2 + 0*15, Game.DIM_Y/2 - 2*15],
		5: [Game.DIM_X/2 + 0*15, Game.DIM_Y/2 - 0*15],
		6: [Game.DIM_X/2 + 0*15, Game.DIM_Y/2 + 2*15],
	
		7: [Game.DIM_X/2 - 2*15, Game.DIM_Y/2 - 3*15],
		8: [Game.DIM_X/2 - 2*15, Game.DIM_Y/2 - 1*15],
		9: [Game.DIM_X/2 - 2*15, Game.DIM_Y/2 + 1*15],
		10: [Game.DIM_X/2 - 2*15, Game.DIM_Y/2 + 3*15],
	
		11: [Game.DIM_X/2 - 4*15, Game.DIM_Y/2 - 4*15],
		12: [Game.DIM_X/2 - 4*15, Game.DIM_Y/2 - 2*15],
		13: [Game.DIM_X/2 - 4*15, Game.DIM_Y/2 + 0*15],
		14: [Game.DIM_X/2 - 4*15, Game.DIM_Y/2 + 2*15],
		15: [Game.DIM_X/2 - 4*15, Game.DIM_Y/2 + 4*15]
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Ball.prototype.isCollidedWith = function (otherBall) {
		...
		if (distanceBetween <= 1.01*(this.radius + otherBall.radius)) { 
