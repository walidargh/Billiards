...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.draw = function (ctx, event) {
		...
		ctx.fillRect(Game.offSet / 2 - 50, Game.offSet / 2, Game.DIM_X + 100, Game.DIM_Y);
	
		ctx.fillRect(Game.offSet / 2, Game.offSet / 2 - 50, Game.DIM_X, Game.DIM_Y + 100);
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 2, 50, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2 + Game.DIM_X, Game.offSet / 2, 50, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 2 + Game.DIM_Y, 50, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2 + Game.DIM_X, Game.offSet / 2 + Game.DIM_Y, 50, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.fillStyle = "#000000";
		ctx.fillRect((Game.offSet - 3.5) / 2, (Game.offSet - 3.5) / 2, Game.DIM_X + 4, Game.DIM_Y + 4);
		...
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 2, 28, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.DIM_Y + Game.offSet / 2, 28, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2, Game.offSet / 2, 28, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2, Game.DIM_Y + Game.offSet / 2, 28, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var welcomeModal = React.createClass({
		...
		nextSlide: function () {
			...
			nextSlideNumber = nextSlideNumber > this.state.totalSlides ? 1 : nextSlideNumber;
		...
		slideThree: function () {
			return React.createElement(
				...
				React.createElement(
					'p',
					null,
					'If you click the cue ball while it is still moving to active the Canon Ball!'
				),
				React.createElement(
					'p',
					null,
					'Be careful the ball will behave unpredictably! But if timed well it can have excellent results'
				),
				React.createElement(
					'p',
					null,
