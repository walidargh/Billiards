...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
		...
		ReactDOM.render(React.createElement(Modal, { startGame: startGame.bind(this, ctx) }), canvasEl);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.draw = function (ctx, event) {
		...
		ctx.fillRect(Game.offSet / 2 - 50, Game.offSet / 4, Game.DIM_X + 100, Game.DIM_Y);
	
		ctx.fillRect(Game.offSet / 2, Game.offSet / 4 - 50, Game.DIM_X, Game.DIM_Y + 100);
	
		this.drawCorners(ctx);
	
		ctx.fillStyle = "#000000";
		ctx.fillRect((Game.offSet - 3.5) / 2, (Game.offSet / 2 - 3.5) / 2, Game.DIM_X + 4, Game.DIM_Y + 4);
	...
	Game.prototype.drawOutline = function (ctx) {
		ctx.fillStyle = "#000000";
		ctx.fillRect(Game.offSet / 2 - 52, Game.offSet / 4, Game.DIM_X + 104, Game.DIM_Y);
	
		ctx.fillRect(Game.offSet / 2, Game.offSet / 4 - 52, Game.DIM_X, Game.DIM_Y + 104);
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, 52, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 4, 52, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2, Game.offSet / 4, 52, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, 52, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	};
	...
	Game.prototype.drawHoles = function (ctx) {
		...
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 4, 28, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, 28, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2, Game.offSet / 4, 28, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, 28, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.fillStyle = "#474747";
		ctx.beginPath();
		ctx.arc(Game.offSet / 2 + 2, Game.offSet / 4 + 2, 24, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2 - 2, Game.offSet / 4 + 2, 24, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2 + 2, Game.DIM_Y + Game.offSet / 4 - 2, 24, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.DIM_X + Game.offSet / 2 - 2, Game.DIM_Y + Game.offSet / 4 - 2, 24, 0, 2 * Math.PI, true);
		ctx.closePath();
		ctx.fill();
	};
	...
	Game.prototype.drawCorners = function (ctx) {
		...
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 4, 50, 1.5 * Math.PI, Math.PI, true);
		ctx.lineTo(Game.offSet / 2, Game.offSet / 4);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2 + Game.DIM_X, Game.offSet / 4, 50, 0, 1.5 * Math.PI, true);
		ctx.lineTo(Game.offSet / 2 + Game.DIM_X, Game.offSet / 4);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2, Game.offSet / 4 + Game.DIM_Y, 50, Math.PI, 0.5 * Math.PI, true);
		ctx.lineTo(Game.offSet / 2, Game.offSet / 4 + Game.DIM_Y);
		ctx.closePath();
		ctx.fill();
	
		ctx.beginPath();
		ctx.arc(Game.offSet / 2 + Game.DIM_X, Game.offSet / 4 + Game.DIM_Y, 50, 0.5 * Math.PI, 2 * Math.PI, true);
		ctx.lineTo(Game.offSet / 2 + Game.DIM_X, Game.offSet / 4 + Game.DIM_Y);
		ctx.closePath();
		ctx.fill();
	
		ctx.fillRect(Game.offSet / 2, Game.offSet / 4, 25, -50);
		ctx.fillRect(Game.offSet / 2, Game.offSet / 4, -50, 25);
	
		ctx.fillRect(Game.DIM_X + Game.offSet / 2, Game.offSet / 4, 50, 25);
		ctx.fillRect(Game.DIM_X + Game.offSet / 2, Game.offSet / 4, -25, -50);
	
		ctx.fillRect(Game.DIM_X + Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, -25, 50);
		ctx.fillRect(Game.DIM_X + Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, 50, -25);
	
		ctx.fillRect(Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, 25, 50);
		ctx.fillRect(Game.offSet / 2, Game.DIM_Y + Game.offSet / 4, -50, -25);
	};
	...
	Game.prototype.drawDots = function (ctx) {
		...
		[1, 2, 3, 4, 5, 6, 7].forEach(function (i) {
			ctx.beginPath();
			ctx.arc(Game.offSet / 2 + 28 + 101.875 * i, Game.offSet / 4 - 25, 4, 0, 2 * Math.PI, true);
			ctx.closePath();
			ctx.fill();
		});
		...
		[1, 2, 3, 4].forEach(function (i) {
			ctx.beginPath();
			ctx.arc(Game.offSet / 2 - 28, Game.offSet / 4 + 25 + 76 * i, 4, 0, 2 * Math.PI, true);
			ctx.closePath();
			ctx.fill();
		});
		...
		[1, 2, 3, 4, 5, 6, 7].forEach(function (i) {
			ctx.beginPath();
			ctx.arc(Game.offSet / 2 + 28 + 101.875 * i, Game.DIM_Y + Game.offSet / 4 + 25, 4, 0, 2 * Math.PI, true);
			ctx.closePath();
			ctx.fill();
		});
		...
		[1, 2, 3, 4].forEach(function (i) {
			ctx.beginPath();
			ctx.arc(Game.DIM_X + Game.offSet / 2 + 28, Game.offSet / 4 + 25 + 76 * i, 4, 0, 2 * Math.PI, true);
			ctx.closePath();
			ctx.fill();
		});
	};
	...
	Game.prototype.isOutOfBounds = function (ball) {
		...
		if (ball.position[0] > Game.RAILS.right - ball.radius) {
			this.backInFrame(ball, [ball.position[0] - (Game.RAILS.right - ball.radius), 0]);
			return [-1, 1];
		}
		//LEFT
		else if (ball.position[0] <= Game.RAILS.left + ball.radius) {
				this.backInFrame(ball, [Game.RAILS.left + ball.radius - ball.position[0], 0]);
				return [-1, 1];
			}
			//BOTTOM
			else if (ball.position[1] > Game.RAILS.bottom - ball.radius) {
					this.backInFrame(ball, [0, ball.position[1] - Game.RAILS.bottom + ball.radius]);
					return [1, -1];
				}
				//TOP
				else if (ball.position[1] < Game.RAILS.top + ball.radius) {
						this.backInFrame(ball, [0, ball.radius + Game.RAILS.top - ball.position[1]]);
						return [1, -1];
					} else {
						return false;
					}
		...
		Object.keys(self.balls).forEach(function (i) {
			...
			Object.keys(self.balls).forEach(function (j) {
				...
				if (ball.isCollidedWith(otherBall)) {
					ball.ballCollision(initialVelocities[otherBall.number], otherBall.position);
				}
			});
		});
	};
	...
	Game.prototype.weaponAction = function () {
		var selectedWeapon = this.weapons[Math.floor(Math.random() * this.weapons.length)];
...
/***/ function(module, exports, __webpack_require__) {
	...
	Ball.prototype.draw = function (ctx) {
		...
		ctx.beginPath();
		ctx.shadowColor = '#000F00';
		ctx.shadowBlur = 1;
		ctx.shadowOffsetX = 1;
		ctx.shadowOffsetY = 1;
		ctx.arc(this.position[0], this.position[1], RADIUS, 0, 2 * Math.PI, true);
		ctx.fill();
		ctx.closePath();
		ctx.shadowBlur = 0;
		ctx.shadowOffsetX = 0;
		...
		if (this.number) {
			ctx.fillStyle = "#FFFFFF";
			ctx.beginPath();
			ctx.arc(this.position[0], this.position[1], RADIUS - 4, 0, 2 * Math.PI, true);
			ctx.fill();
			ctx.closePath();
			ctx.font = "10px Arial";
			ctx.fillStyle = 'black';
			ctx.fillText(this.number, this.position[0] - 3 * String(this.number).length, this.position[1] + 3);
		}
	};
	...
	Ball.prototype.isCollidedWith = function (otherBall) {
		...
		if (distanceBetween <= this.radius + otherBall.radius) {
			...
			var scaleFactorA = moveBackDistanceA === 0 ? 0 : -1 * moveBackDistanceA / Util.norm(this.velocity);
			var scaleFactorB = moveBackDistanceB === 0 ? 0 : -1 * moveBackDistanceB / Util.norm(otherBall.velocity);
	...
	Ball.prototype.tableFriction = function (deltaTime) {
		...
		var frictionOffsetSpeed = 1 / (BALL_TABLE_FRICTION_MAX - BALL_TABLE_FRICTION_MIN);
		var kineticFactor = 1 / (Math.pow(ballSpeed, 2) + frictionOffsetSpeed) + BALL_TABLE_FRICTION_MIN;
	...
	Ball.prototype.ballCollision = function (otherInitialVelocity, otherPosition) {
		var shiftedVelocity = Util.velocityShift(this.velocity, otherInitialVelocity, this.position, otherPosition);
		// var xVelocity =
...
/***/ function(module, exports, __webpack_require__) {
	...
	Cue.prototype.calculateVelocity = function (event) {
		...
		var end = [event.pageX - canvas.offsetLeft, event.offsetY];
...
/***/ function(module, exports, __webpack_require__) {
	...
	Weapon.prototype.action = function (position, cueBall) {
		if (this.count > 0 && Util.norm(cueBall.velocity) > 0.1) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// GameView.prototype.getImg = function () {
	// 	var cueImg = new Image();
	// 	cueImg.src = './images/pool_cue.png';
	// 	this.cueImg = cueImg;
	// };
	...
	GameView.prototype.animate = function (time, event) {
		...
		if (this.moved) this.game.draw(this.ctx, this.event, this.cueImg);else this.game.draw(this.ctx, this.cueImg);
		this.moved = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var welcomeModal = React.createClass({
		...
		nextSlide: function () {
			...
			nextSlideNumber = nextSlideNumber > this.state.totalSlides ? null : nextSlideNumber;
	
			nextSlideNumber ? this.setState({ slideNumber: nextSlideNumber }) : this.closeModal();
		},
	
		previousSlide: function () {
			var prevSlideNumber = this.state.slideNumber - 1;
			prevSlideNumber = prevSlideNumber < 0 ? this.state.totalSlides : prevSlideNumber;
		...
		slideOne: function () {
			return React.createElement(
				...
				React.createElement(
					'p',
					null,
					'Your goal is to pocket all the balls except the cue ball, which will result in an automatic loss'
				),
				React.createElement('img', { src: 'https://s3-us-west-1.amazonaws.com/owlhowler/howler/cueball.png' })
			);
		},
		...
		slideTwo: function () {
			return React.createElement(
				...
				React.createElement(
					'p',
					null,
					'Drag the cue back with your mouse and release to strike the cueball'
				),
				React.createElement(
					'p',
					null,
					'The further you pull back the harder it will strike!'
				),
				React.createElement('img', { style: { borderRadius: 0 }, src: 'https://s3-us-west-1.amazonaws.com/owlhowler/howler/cuestrike.png' })
			);
		},
		...
		slideThree: function () {
			return React.createElement(
				...
				React.createElement(
					'p',
					null,
					'If you click the cue ball while it is still moving to activate a canonball!'
				),
				React.createElement(
					'p',
					null,
					'Be careful the ball will behave unpredictably! But if timed well it can have explosive results'
				),
				React.createElement(
					'p',
					null,
					'You will have three canonballs, use them wisely'
				),
				React.createElement('img', { src: 'https://s3-us-west-1.amazonaws.com/owlhowler/howler/cannonball.png' })
			);
		},
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'button',
						{ className: 'previous-slide', onClick: this.previousSlide },
						'Previous'
					),
					this.currentSlide(),
					React.createElement(
						'button',
						{ className: 'next-slide', onClick: this.nextSlide },
						'Next'
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderSubtreeIntoContainer = __webpack_require__(44).unstable_renderSubtreeIntoContainer;
